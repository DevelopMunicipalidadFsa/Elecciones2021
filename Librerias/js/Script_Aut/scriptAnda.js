...
==================================*/
	function pregunta(dataIde){
		var formulario = "formulario"+dataIde;
		Swal.fire({
...
// 	document.getElementById("Aut_Botonera").style.display = "none";
...
// 	window.print();
// 	setTimeout(function() {
// 		location.reload();$('#informacion').show();
// 	}, 100);
// }
function sacarBoton(){
...
$(document).ready(function(){
	$(document).on('click', '.rta', function(){
		...
		if (tituloAutomotorJS == 1) {
			var checkbox = document.getElementById("inlineCheckbox1"); // Aqui seleccionas tu checkbox.
			$("#inlineCheckbox1").attr('checked',true); // Aqui le agregas el checked.
			$("#inlineCheckbox1").attr('disabled',true);
   	    	$('.input').append('<input type="hidden" name="FotocopiaTítuloAutomotor" value="1"/>');
   	    	$('.input').append('<input type="hidden" name="titulo1" value="Fotocopia del Título del Automotor."/>');
		...
		if (dniFrenteJS == 1) {
			...
			$("#inlineCheckbox2").attr('disabled',true);
   	    	$('.input').append('<input type="hidden" name="FotocopiaDNIFrente" value="2"/>');
   	    	$('.input').append('<input type="hidden" name="titulo2" value="Fotocopia del DNI Frente."/>');
		...
		if (dniDorsoJS == 1) {
			...
			$("#inlineCheckbox3").attr('disabled',true);
   	    	$('.input').append('<input type="hidden" name="FotocopiaDNIDorso" value="7"/>');
   	    	$('.input').append('<input type="hidden" name="titulo3" value="Fotocopia del DNI Dorso."/>');
		...
		if (formulario04RegAutJS == 1) {
			...
			$("#inlineCheckbox4").attr('disabled',true);
   	    	$('.input').append('<input type="hidden" name="Formulario04RegAut" value="36"/>');
   	    	$('.input').append('<input type="hidden" name="titulo4" value="Formulario 04 emitido por el Registro del Automotor."/>');
   	    	$("#file4").attr("required", true);			
		} else{
			$(".inlineCheckbox4").hide(); // Aqui le quitas el checked.
		}
		$('.input').append('<input type="hidden" name="idSolicitud" value="'+idSolicitud+'"/>');
