		...
		<div class="table mb-5">
			<table class="table text-center">
				...
				<tbody>
					...
					<form action="FormularioV3" method="POST" id="carga2">
						<tr>
							...
							<td class="w-25">
								<?php $ConsultaCarga=ControladorElecciones::ctrConsultaCarga($_POST['Mesa'],$Sublemas[2]);
										if (empty($ConsultaCarga)){  ?>
											<input type="number" name="valor[]" onClick="this.select();" class="form-control form-control-sm cantidad" value=0 required autofocus>
								<?php }else{ ?>
					...
					<?php $i ++; } ?>
						...
						<button class="btn btn-white btn-flotante mb-1 text-primary" form="carga2" type="submit" id="seleccionar">
