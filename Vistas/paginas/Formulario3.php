		...
		<div class="table mb-5">
			<table class="table text-center">
				...
				<tbody>
							...
							<td class="w-25">
								<?php 	$ConsultaCarga=ControladorElecciones::ctrConsultaCargaPartidos($_POST['Mesa'],$Partido[0]);
										if (empty($ConsultaCarga)){  ?>
											<input type="number" name="valorPartidoCarga[]" onClick="this.select();" class="form-control form-control-sm cantidad" required autofocus>
								<?php }else{ ?>
					...
					<?php $i++; } ?>
						<button class="btn btn-white btn-flotante mb-1 color" form="carga3" type="submit" id="seleccionar">
