		...
		<div class="table mb-5">
			<table class="table text-center">
				...
				<tbody>
					...
					<form action="FormularioV2" method="POST" name="formulario1">
						<tr>
							...
							<td class="w-25">
								<?php $ConsultaCarga=ControladorElecciones::ctrConsultaCarga($_POST['Mesa'],$Sublemas[2]);
										if (empty($ConsultaCarga)){  ?>
											<input type="number" name="valor[]" onClick="this.select();" class="form-control form-control-sm cantidad" value=0 autofocus>
								<?php }else{ ?>
						...
						<tr class="bg-primary text-white">
							...
							<td class="w-25"><input type="number" name="totalValores" id="total" value=0 class="form-control form-control-sm" readonly></td>
						</tr>
						<button class="btn btn-white btn-flotante mb-1 text-primary"  type="submit" id="seleccionar" onclick="dimePropiedades(event)">
